...
enum mgos_app_init_result mgos_app_init(void) {
  ...
  mgos_ssd1306_draw_string(oled, mgos_sys_config_get_x(), mgos_sys_config_get_y(), "Lorem ipsum dolor sit");
  mgos_ssd1306_draw_circle(oled, 20, 20, 10, SSD1306_COLOR_WHITE);
  // mgos_ssd1306_fill_rectangle(oled, 20, 20, 50, 30, SSD1306_COLOR_WHITE);
  mgos_ssd1306_draw_pixel(oled, 64, 32, SSD1306_COLOR_WHITE);
  mgos_ssd1306_flip_display(oled, true, true);
  // mgos_ssd1306_invert_display(oled, true);
  mgos_ssd1306_refresh(oled, false);
  return MGOS_APP_INIT_SUCCESS;
}
